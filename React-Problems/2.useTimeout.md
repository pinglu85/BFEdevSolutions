...
If we use a wrapper function and call the `callback` within it, `callback` will be a reference. It will point to the new callback function at the time it is called:
